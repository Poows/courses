...
void FirstTest() {
	...
	AssertEqual(IsPalindrom("a "), false, "1-27");
	AssertEqual(IsPalindrom("  a "), false, "1-28");
	AssertEqual(IsPalindrom(" a "), true, "1-29");
	AssertEqual(IsPalindrom("          aba"), false, "1-30");
	AssertEqual(IsPalindrom("          aba  "), false, "1-31");
	AssertEqual(IsPalindrom("\taba     "), false, "1-32");
	AssertEqual(IsPalindrom("ma dam"), false, "1-33");
	AssertEqual(IsPalindrom("moM"), false, "1-34");
}
